...
def main():
    ...
    while True:
        ...
        #Draw Edges
        glBegin(GL_LINES)
        for i, j in hypercube_4d.edges:
            glColor3f(1.0, 1.0, 1.0)
            glVertex3f(*projected_vertices_4d[i] * scale)
            glVertex3f(*projected_vertices_4d[j] * scale)
        glEnd()
       ...
       #Draw Edges
        glBegin(GL_LINES)
        for i, j in hypercube_5d.edges:
            glColor3f(1.0, 1.0, 0.0)
            glVertex3f(*projected_vertices_5d[i] * scale)
            glVertex3f(*projected_vertices_5d[j] * scale)
        glEnd()
